...
abis = {
    ...
    {
      "inputs": [],
      "name": "AggchainDataMustBeZeroForPessimisticVerifierType",
      "type": "error"
    },
    {
      "inputs": [],
    ...
    {
      "inputs": [],
      "name": "InvalidInputsForRollupType",
      "type": "error"
    },
    {
      "inputs": [],
    ...
    },
    {
      ...
      "inputs": [
        ...
        },
        {
          "indexed": False,
          "internalType": "bytes",
          "name": "initializeBytesAggchain",
          "type": "bytes"
        }
      ],
      "name": "CreateNewAggchain",
      "type": "event"
    },
    {
      "anonymous": False,
    ...
    },
    {
      ...
      "name": "VerifyPessimisticStateTransition",
      "type": "event"
    },
    {
      "inputs": [],
    ...
    },
    {
      ...
      "name": "rollupIDToRollupDataV2Deserialized",
      "outputs": [
        {
          "internalType": "address",
          "name": "rollupContract",
